...
INSERT INTO [dbo].[Car] ([Id], [CarClass], [Color], [Description], [EngDisplacement], [FuelType], [MaintenanceTypes], [Manufacturer], [PurchasingPrice], [QuantityForPurchasing], [QuantityForRenting], [RentingPrice], [RimSize], [ModelId]) VALUES (5, N'Compacto', N'Blanco', N'Toyota Corolla 1.8L Sedan', N'1.8', N'Gasolina', N'Estandar', N'Toyota', CAST(22000.00 AS Decimal(10, 2)), 5, 200, CAST(75.00 AS Decimal(10, 2)), 16, N'1')
